...
+---------------------+------------------------------------------------------------------------------+
| ``master``          | .. image:: https://travis-ci.org/artometa/jinja.svg?branch=master            |
|                     |     :target: https://travis-ci.org/artometa/jinja                            |
+---------------------+------------------------------------------------------------------------------+
| ``2.9-maintenance`` | .. image:: https://travis-ci.org/artometa/jinja.svg?branch=2.9-maintenance   |
|                     |     :target: https://travis-ci.org/artometa/jinja                            |
+---------------------+------------------------------------------------------------------------------+
